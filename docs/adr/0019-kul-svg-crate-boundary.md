...
- **Edge routing in v1 is orthogonal right-angle for `InTree` edges:** bar-midpoint drops to a horizontal bus mid-row, then drops to each child's card top. Matches classical descendency-tree convention (P1).

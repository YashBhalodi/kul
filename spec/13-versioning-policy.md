...
The version a document targets is declared in the project manifest's `kul:` field — see [Section 14 — Project manifest](./14-project-manifest.md). The `MAJOR.MINOR` semantics and additivity guarantees in this section are independent of where the version literal lives; only the location moved when the manifest replaced the in-grammar declaration.
...
← [Section 12 — Formal grammar](./12-formal-grammar.md) | [Section 14 — Project manifest](./14-project-manifest.md) | [Index](./README.md)

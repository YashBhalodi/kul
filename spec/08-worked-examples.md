...
[`../examples/01-single-couple.kul`](../examples/01-single-couple.kul)
...
[`../examples/02-nuclear-family.kul`](../examples/02-nuclear-family.kul)
...
[`../examples/03-three-generations.kul`](../examples/03-three-generations.kul)
...
[`../examples/04-polygamous-family.kul`](../examples/04-polygamous-family.kul)
